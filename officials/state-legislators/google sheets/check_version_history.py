...
if __name__ == '__main__': 
    ...
    for state in states:  # Test with one state for now
        ...
        # ------------------------------------
        version_history = google_utils.get_version_history(sheetname=state, folder=os.environ['PATH-TO-GOOGLE-CREDS'])
        if version_history:
            ...
            version_history = [v for v in version_history if v['editor'] != 'main-812@sonorous-antler-441519-p0.iam.gserviceaccount.com']
