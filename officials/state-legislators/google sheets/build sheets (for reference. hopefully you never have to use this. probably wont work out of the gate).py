...
credentials_file = os.environ['PATH-TO-GOOGLE-CREDS']
...
shared_folder_id_global = os.environ['PATH-TO-GOOGLE-CREDS']
...
def build_sheet(state_name,  stateleg, shared_folder_id=os.environ['PATH-TO-GOOGLE-CREDS']):
...
# for state in ['AL']:
    ...
    # IMPORT
    # state_data_from_google = google_utils.pull_data(sheetname=state, folder=os.environ['PATH-TO-GOOGLE-CREDS'])
    ...
    exit()
    # google_utils.push_data(sheetname=state, folder=os.environ['PATH-TO-GOOGLE-CREDS'], data=state_data_from_db)
    # print(f'---------------done----------------')
    # time.sleep(15)
