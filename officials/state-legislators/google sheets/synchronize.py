...
if __name__ == '__main__': 
    ...
    for state in states:
        ...
        state_data_from_sheets = google_utils.pull_data(sheetname=state, folder=os.environ['STATE-DATA-CURATION-FOLDER'])
        ...
        if state_data_from_sheets is not None:
            ...
            google_utils.push_data(sheetname = state, folder = os.environ['STATE-DATA-CURATION-FOLDER'], data = state_data_from_db)
