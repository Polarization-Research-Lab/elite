...
Provide a 20ish word explanation and save as attack_reasoning
...
Task: Assess the text for a policy_attack (output either "yes" or "no"). If "yes", ensure the text meets the criteria below. If "no", output "policy_attack": "no". Provide a 20ish word explanation and save as policy_reasoning
...
Task: Assess the text for is_bipartisanship (output either "yes" or "no"). If "yes", also provide a brief bipartisanship_reasoning explanation (around 20 words) based on the text.
...
Task: Assess the text for is_creditclaiming (output either "yes" or "no"). If "yes", also provide a brief creditclaiming_reasoning explanation (around 20 words) based on the text.
...
Task: Asses if policy is discussed and determine the policy_area from the list below and provide a policy_reasoning (approximately 20 words) explaining why the text fits in the selected area.
